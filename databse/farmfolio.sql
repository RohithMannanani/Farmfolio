...
INSERT INTO `tbl_orders` (`order_id`, `user_id`, `total_amount`, `order_status`, `order_date`, `delivery_address`, `phone_number`, `payment_method`, `payment_status`) VALUES
(5, 36, 6.00, 'cancelled', '2025-03-17 21:38:05', 'Puthupuredathu(H)\r\nKavumbhagom(PO)\r\nCheruvally\r\n686519', '8590177602', 'cod', 'pending'),
(6, 36, 18.00, 'delivered', '2025-03-17 21:44:13', 'Puthupuredathu(H)\r\nKavumbhagom(PO)\r\nCheruvally\r\n686519', '8590177602', 'cod', 'pending'),
(7, 36, 12.00, 'pending', '2025-03-17 22:18:10', 'Puthupuredathu(H)\r\nKavumbhagom(PO)\r\nCheruvally\r\n686519', '8590177602', 'cod', 'pending'),
(8, 36, 200.00, 'pending', '2025-03-18 06:55:24', 'Valiyil (H)\r\nKavumbhagom(PO)\r\nCharuvally\r\n686519', '6282919440', 'cod', 'pending');
...
(8, 6, 20, 3, 6.00, 18.00),
(9, 7, 20, 2, 6.00, 12.00),
(10, 8, 22, 2, 55.00, 110.00),
(11, 8, 21, 2, 45.00, 90.00);
...
(20, 8, 'Eggs', 6.00, 100, 'fresh eggs ', '2025-03-17 15:26:44', 8, 'ml', '0'),
(21, 9, 'Rambutan', 45.00, 100, 'Fresh rambutan from our plantation', '2025-03-18 00:09:58', 10, 'kg', '0'),
(22, 9, 'Mango', 55.00, 100, 'fresh mango..', '2025-03-18 00:12:30', 11, 'kg', '0');
...
(1, 8, 36, 3, 'a good farm and good service ', '2025-03-17 15:28:10'),
